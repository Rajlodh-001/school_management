...
export const messagesData = [
  {
    ...
    date: "2025-01-01",
    time: "10:00",
    message: "A relaxing trip to the lake, enjoying nature and fun activities."
  },
  {
    id: 2,
    from: "Alice Smith",
    date: "2025-01-01",
    time: "10:00",
    message: "A delightful outdoor picnic with delicious food and games."
  },
  {
    id: 3,
    ...
    date: "2025-01-01",
    time: "10:00",
    message: "A fun-filled day at the beach with swimming and sandcastle building."
  },
  {
    id: 4,
    from: "Emma Brown",
    date: "2025-01-01",
    time: "10:00",
    message: "An educational visit to the museum exploring history and art."
  },
  {
    id: 5,
    from: "William Davis",
    date: "2025-01-01",
    time: "10:00",
    message: "An energetic music concert featuring live performances and entertainment."
  },
  {
    id: 6,
    from: "Sophia Wilson",
    date: "2025-01-01",
    time: "10:00",
    message: "A thrilling magician show full of surprises, tricks, and illusions."
  },
  {
    id: 7,
    from: "James Anderson",
    date: "2025-01-01",
    time: "10:00",
    message: "A peaceful and scenic trip to the lake for adventure and relaxation."
  },
  {
    id: 8,
    ...
    date: "2025-01-01",
    time: "10:00",
    message: "A thrilling cycling race to test endurance and speed in a fun setting."
  },
  {
    id: 9,
    ...
    date: "2025-01-01",
    time: "10:00",
    message: "A showcase of creative artworks by talented artists in a gallery."
  },
  {
    id: 10,
    ...
    date: "2025-01-01",
    time: "10:00",
    message: "An exciting sports event with different games and team competitions."
  }
];
...
export const calendarEvents: { title: string; allDay: boolean; start: Date; end: Date; }[] = [];
...
for (let day = 1; day <= 31; day++) {
  ...
  shuffledSubjects.forEach((subject, index) => {
    const { hour, minute } = shuffledTimeSlots[index];

    calendarEvents.push({
      title: subject,
      allDay: false,
      start: new Date(2025, currentMonth, day, hour, minute),
      end: new Date(2025, currentMonth, day, hour, minute + 45),
    });
  });
}
